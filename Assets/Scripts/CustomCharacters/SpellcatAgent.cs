...
namespace EasyCharacterMovement
{
	...
	public class SpellcatAgent : Character
	{
		...
		protected bool _mouseButtonMovePressed;
		protected bool _mouseButtonInteractPressed;
		...
		protected InputAction mouseClickMoveInputAction { get; set; }
		protected InputAction mouseClickInteractInputAction { get; set; }
		...
		protected virtual void OnMouseClickMove(InputAction.CallbackContext context)
		{
			_mouseButtonMovePressed = context.started || context.performed;
		}
		protected virtual void OnMouseClickInteract(InputAction.CallbackContext context)
		{
			_mouseButtonInteractPressed = context.started || context.performed;
		}
		...
		protected override void InitPlayerInput()
		{
			...
			mouseClickMoveInputAction = inputActions["Mouse Click Move"];
			if (mouseClickMoveInputAction != null)
			{
				mouseClickMoveInputAction.started += OnMouseClickMove;
				mouseClickMoveInputAction.performed += OnMouseClickMove;
				mouseClickMoveInputAction.canceled += OnMouseClickMove;

				mouseClickMoveInputAction.Enable();
			}
			mouseClickInteractInputAction = inputActions["Mouse Click Interact"];
			if (mouseClickInteractInputAction != null)
			{
				mouseClickInteractInputAction.started += OnMouseClickInteract;
				mouseClickInteractInputAction.performed += OnMouseClickInteract;
				mouseClickInteractInputAction.canceled += OnMouseClickInteract;

				mouseClickInteractInputAction.Enable();
			}
		}
		...
		protected override void DeinitPlayerInput()
		{
			...
			if (mouseClickMoveInputAction != null)
			{
				...
				mouseClickMoveInputAction.Disable();
				mouseClickMoveInputAction = null;
			}
		}
